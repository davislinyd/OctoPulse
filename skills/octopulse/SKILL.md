...
- Grok Build discovers this shared skill from `~/.agents/skills`. Its optional Stop hook only refreshes changed reports; it never injects context, reads prompts, writes `.otcopulse`, or records activity.
